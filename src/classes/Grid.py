...
class Grid:
    ...
    def __init__(self, grid_weights: pd.DataFrame, hypothetical_returns: pd.DataFrame, real_returns: pd.DataFrame,
                 annalization_factor: int = 4) -> None:
        """
    ...
    def plot_weights_evolution(self,
                               title: str = "Evolution de l'allocation en fonction du nombre d'années avant la retraite") -> plt.Axes:
        """
    ...
    def plot_risk_return(self,
                         title: str = "Evolution du couple risque/rendement en fonction du nombre d'années avant la retraite") -> plt.Figure:
        """
    ...
    def plot_correlation_heatmap(self, title: str = "Matrice de corrélation des rendements historiques",
                                 annot: bool = False) -> plt.Axes:
        """
    ...
    def plot_gini_evolution(self,
                            title: str = "Evolution du coefficient de Gini (concentration des actifs)") -> plt.Figure:
        """
    ...
    def optimize_grid(self, initial_grid: 'Grid', max_gini: float = 0.6) -> 'Grid':
        ...
        def optimize_single_horizon(horizon: Union[int, str]) -> Tuple[
            Union[int, str], np.ndarray, float, float, float, bool]:
            """
